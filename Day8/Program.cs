...
namespace Day8
{
    internal class Program
    {
            ...
            Console.WriteLine("Select one Option for \n 1. Write a C# program that matches a string that has an ‘a’ followed by two to three 'b'\n" +
               ...
               " 3. Count the number of occurrences of the pattern in a given string.");
            int option = Convert.ToInt32(Console.ReadLine());
                switch (option)
                {
                    case 1:
                    Pattern.Question1("vivekabbkumar");
                    Console.ReadLine();
                    break;
                case 2:
                ...
                case 3:
                    Pattern.Question3("foxes are omnivorous mammals belonging to several genera of the family Canidae fox ");
                    Console.ReadLine();
                    break;
